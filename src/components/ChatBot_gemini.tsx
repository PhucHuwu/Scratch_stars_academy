            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-6 right-6 z-50 w-[420px] max-w-[calc(100vw-48px)] bg-card rounded-2xl shadow-card border border-border overflow-hidden"
                    >
                        {/* Header */}
                                ...
                                >
                                    <div
                                        className={`max-w-[80%] p-3 rounded-2xl ${
                                            message.isBot ? "bg-muted text-foreground rounded-tl-md" : "bg-primary text-primary-foreground rounded-tr-md"
                                        }`}
                                    >
                                        {message.isBot && (
                        ...
                        <div className="p-4 border-t border-border">
                            ...
                            <p className="text-xs text-muted-foreground text-center mt-2">{/* Powered by Gemini AI */}</p>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
